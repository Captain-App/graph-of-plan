...
export const PLAN = defineGraph({
  ...
  assumptions: {
    ...
    // ========================================================================
    // CYCLE 1-3 HIDDEN ASSUMPTIONS - surfaced through recursive analysis
    // ========================================================================

    "security-incidents-will-occur": {
      title: "Security Incidents Will Drive Demand",
      statement: "Security incidents in AI agent systems will occur and create market pressure for isolation, similar to how browser security incidents drove sandboxing adoption.",
      category: "market",
      status: "untested",
      criticality: "foundation",
      testMethod: "Monitor security research, CVE databases, and news for agent-related incidents. Track enterprise security team concerns.",
      validationCriteria: [
      ...
      reviewFrequency: "monthly",
      dependentProducts: ["smartboxes"],
      // This is what agents-need-sandboxes actually rests on
    },
    "developers-control-purchasing": {
      title: "Developers Control Purchasing",
      statement: "Individual developers can make purchasing decisions for tools under $200/month without procurement approval in their organisations.",
      category: "customer",
      status: "untested",
      criticality: "critical",
      testMethod: "Customer interviews about purchasing authority. Track signup-to-paid conversion by company size.",
      validationCriteria: [
    ...
    "stated-wtp-equals-actual": {
      title: "Interview WTP Translates to Purchases",
      statement: "Willingness to pay expressed in customer discovery interviews translates to actual credit card purchases at similar price points.",
      category: "customer",
      status: "untested",
      criticality: "critical",
      testMethod: "Compare stated WTP in interviews to actual conversion rates and price points achieved.",
      validationCriteria: [
      ...
      confidence: 40,
      reviewFrequency: "monthly",
      dependentProducts: ["smartboxes", "murphy", "nomos-cloud"],
      dependsOnAssumptions: ["developers-will-pay-for-sandboxes"],
    },
    "ai-productivity-sustained": {
      title: "AI Productivity Gains Are Sustained",
      statement: "AI coding assistance (Claude Code, Cursor, Copilot) productivity gains will sustain beyond the novelty period and continue improving.",
      category: "operational",
      status: "testing",
      criticality: "critical",
      testMethod: "Track personal productivity metrics over time. Monitor industry reports on AI coding tool effectiveness.",
      validationCriteria: [
    ...
    "cloudflare-welcomes-use-case": {
      title: "Cloudflare Welcomes Agent Sandbox Workloads",
      statement: "Cloudflare will continue to welcome agent sandbox workloads on their platform and not view them as abuse or undesirable traffic.",
      category: "technical",
      status: "untested",
      criticality: "critical",
      testMethod: "Direct communication with Cloudflare. Monitor ToS changes. Track their own agent sandbox product development.",
      validationCriteria: [
    ...
    "non-devs-can-verify-output": {
      title: "Non-Developers Can Verify Agent Output",
      statement: "Non-technical users can verify that AI agent output is correct without understanding the underlying code, enabling trust in agent actions.",
      category: "customer",
      status: "untested",
      criticality: "important",
      testMethod: "User testing with non-developers. Track error rates and trust metrics in beta cohort.",
      validationCriteria: [
      ...
      reviewFrequency: "monthly",
      dependentProducts: ["smartboxes", "p4gent"],
      dependsOnAssumptions: ["non-devs-want-ai-tools"],
    },
    "software-prediction-possible": {
      title: "Software Project Prediction Is Possible",
      statement: "Software project delivery timelines can be predicted with useful accuracy (within 30% of actual) by AI analysis of project data.",
      category: "technical",
      status: "untested",
      criticality: "important",
      testMethod: "Build prediction model. Test on historical project data. Measure accuracy in real projects.",
      validationCriteria: [
      ...
      reviewFrequency: "monthly",
      dependentProducts: ["murphy"],
      dependentMilestones: ["murphy-alpha"],
      dependsOnAssumptions: ["agencies-feel-delivery-pain"],
    },
    "regulations-will-bite": {
      title: "AI Regulations Will Be Enforced",
      statement: "AI regulations (EU AI Act, emerging US frameworks) will be actively enforced within 24 months, creating compliance urgency.",
      category: "market",
      status: "untested",
      criticality: "important",
      testMethod: "Monitor regulatory enforcement actions. Track enterprise compliance requirements in RFPs.",
      validationCriteria: [
      ...
      dependentProducts: ["nomos-cloud"],
      relatedRisks: ["regulatory-ai-autonomy"],
      dependsOnAssumptions: ["audit-trails-required"],
    },
    "breadth-beats-depth": {
      title: "Breadth Beats Depth For Market Learning",
      statement: "Shipping 4 products at 70% quality beats shipping 1 product at 95% quality for learning what the market wants.",
      category: "operational",
      status: "untested",
      criticality: "important",
      testMethod: "Track learnings per product. Compare signal quality from multiple bets vs. single bet.",
      validationCriteria: [
      ...
      confidence: 45,
      reviewFrequency: "quarterly",
      dependentProducts: ["smartboxes", "murphy", "nomos-cloud", "p4gent"],
      relatedRisks: ["execution-team-capacity"],
      dependsOnAssumptions: ["can-ship-fast-enough"],
    },
    "first-mover-advantage-exists": {
      title: "First Mover Advantage Exists in Agent Infra",
      statement: "First movers in agent infrastructure can build durable competitive advantage through brand, integrations, and learning before big tech enters.",
      category: "competitive",
      status: "untested",
      criticality: "important",
      testMethod: "Study historical infrastructure markets. Monitor big tech announcements. Track early mover defensibility.",
      validationCriteria: [
      ...
      reviewFrequency: "quarterly",
      dependentProducts: ["smartboxes"],
      relatedRisks: ["competitive-big-tech"],
      dependsOnAssumptions: ["market-timing-right"],
    },
  },
