...
**Depends on:**
- [Agents Need Sandboxes](/assumption/agents-need-sandboxes) — agents must be autonomous enough to need audit trails
- [Market Timing Is Right](/assumption/market-timing-right) — enterprises must be deploying agents for audit trails to matter
