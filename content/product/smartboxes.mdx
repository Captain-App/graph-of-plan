...
## Strategic Position: The Wedge

SmartBoxes is our **wedge**—the infrastructure that enables [Murphy](/product/murphy) to exist. By itself, SmartBoxes is potentially commodity infrastructure (anyone could build isolated sandboxes). But it's the *required architecture* for Murphy agents to do their job effectively across systems.

This is the [chain-link structure](/diagnosis/chain-link-illegibility): SmartBoxes without Murphy is commodity infrastructure. Murphy without SmartBoxes doesn't work. Each link makes the other valuable.
...
## The Problem: The n² Integration Trap
...
**Developers already solved this for themselves.** Coding agents like Claude Code give developers filesystem access, capability-scoped tokens, persistent context across systems. They have cohesive conversations with agents that can operate across their entire workflow.

**SmartBoxes = that same pattern for everyone else.** Personal, organised like repositories, persistent context. The bitter lesson applied to enabling everyone to be aided by AI—not just developers.
